...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="row">
        ...
        <div class="col-4 mt-5">
            <form action="script/sendOrder.php" method="POST">
                <label for="address"><h4>Enter your address to order</h4></label>
                <input type="text" name="address" class="form-control mb-3" placeholder="Country, City, Address">
